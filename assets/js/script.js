...
var aboutMePageEl0 = document.getElementById("about-me-page-0");
var aboutMePageEl1 = document.getElementById("about-me-page-1");
...
aboutMeButtonEl.addEventListener("click", function(event) {
    ...
    aboutMePageEl0.setAttribute("class", "container main-container p-3 m-3 mx-auto show");
    aboutMePageEl1.setAttribute("class", "container main-container p-3 m-3 mx-auto show");             
